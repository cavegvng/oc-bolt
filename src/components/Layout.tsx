...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* 1. HOT NOW TICKER — highest layer, sticky */}
      <div className="sticky top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur">
        <HotNowTicker />
      ...
      >
        {/* 2. HEADER / MAIN NAV — now sits directly under the ticker */}
        <nav className="sticky top-10 z-40 bg-card shadow-sm border-b border-border">
