...
import { LogOut, User, Home, MessageSquare, TrendingUp, PlusCircle, Sun, Moon, Scale, ChevronDown, Plus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer id="footer" className="bg-card border-t border-border pt-12 mt-24">
        <div className="max-w-7xl mx-auto pt-12 mt-24">   {/* pb-12 instead of py-8 for more bottom room */}
