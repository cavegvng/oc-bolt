...
export function EditDiscussionPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!user || !id) {
      setError('You must be signed in to edit a discussion');
      return;
    }
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-6">
          ...
          <button
            ...
            className="mt-4 px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-colors"
          >
            Back to Discussions
          </button>
        </div>
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-card rounded-3xl p-8 border border-border">
        ...
        <p className="text-muted-foreground mb-8">
          Update your discussion topic and details
        </p>
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-2 gap-4 flex-wrap">
                <p className="text-xs text-muted-foreground">
                  Tip: Paste links from Instagram, Twitter/X, or YouTube and we'll automatically embed them with thumbnails
                </p>
              ...
              <textarea
                ...
                placeholder="Share your thoughts... You can use **bold**, *italic*, and other markdown formatting. Paste Instagram, Twitter/X, or YouTube links to embed them automatically."
